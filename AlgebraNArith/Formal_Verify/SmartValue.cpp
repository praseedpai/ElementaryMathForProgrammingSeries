...
bool CheckCommutativeLaw(SmartValue<int>& a , SmartValue<int>&b ) {

    if ( a + b  == b + a ) { return true; }
    return false;
}

bool CheckAssociativeLaw( SmartValue<int>& a , 
                          SmartValue<int>& b ,
                          SmartValue<int>& c )
{
...
int main()
{
   ...
   SmartValue<int> ps2(20);

   SmartValue<int> ps3(30);


   if ( CheckCommutativeLaw( ps,ps2 ) )
   {
       cout << " Satisfied Commutatiove Law " << endl;
   }

   if ( CheckAssociativeLaw( ps, ps2, ps3 ) )
   {
	cout << "Satisfied Associative Law" << endl;
